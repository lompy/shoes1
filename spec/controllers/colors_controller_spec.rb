...
describe ColorsController do
  ...
  describe "GET index" do
    it "assigns all colors as @records" do
      color = Color.create! valid_attributes
      get :index, {}, valid_session
      assigns(:records).should eq([color])
    end
  end

  describe "GET show" do
    it "assigns the requested color as @record" do
      color = Color.create! valid_attributes
      get :show, {:id => color.to_param}, valid_session
      assigns(:record).should eq(color)
    end
  end

  describe "GET new" do
    it "assigns a new color as @record" do
      get :new, {}, valid_session
      assigns(:record).should be_a_new(Color)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created color as @record" do
        post :create, {:color => valid_attributes}, valid_session
        assigns(:record).should be_a(Color)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved color as @record" do
  ...
  describe "PUT update" do
    ...
    describe "with invalid params" do
      it "assigns the color as @record" do
        color = Color.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        Color.any_instance.stub(:save).and_return(false)
  ...
  describe "GET select" do
    it "assigns all colors to @records" do
      color = Color.create! valid_attributes
      get :select, {shoe_id: 1}, valid_session
      assigns(:records).should eq([color])
    end

    it "assigns params @selet" do
      get :select, {shoe_id: 1}, valid_session
      assigns(:select).should eq(shoe_id: "1")
    end
  end
end
